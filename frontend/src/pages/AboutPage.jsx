        ...
        <div className="row justify-content-center mt-5">
          <div className="col-12 col-md-8 text-center">
            ...
            <div className="text-start feature-card p-5 mb-5">
              ...
              <p className="text-muted mb-4" style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
                PHOENIX-AI is our flagship research initiative—a platform that proves our Phoenix Core SDK can be deployed reliably and efficiently in production environments. We are continuously exploring new paradigms in Hybrid Memory and multi-agent consensus algorithms.
              </p>
            </div>
          </div>
        </div>
